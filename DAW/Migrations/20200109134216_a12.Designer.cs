...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAW.Domain.Models.Station", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DAW.Domain.Models.Train", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DAW.Domain.Models.TrainStation", b =>
                {
                    b.HasOne("DAW.Domain.Models.Station", "Station")
                        .WithMany("TrainStations")
                        .HasForeignKey("StationID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DAW.Domain.Models.Train", "Train")
                        .WithMany("TrainStations")
